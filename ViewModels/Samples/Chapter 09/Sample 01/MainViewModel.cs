...
namespace Book.ViewModels.Samples.Chapter09.Sample01
{
    using System;
    using System.Linq;
    ...
    [Sample(
        "Interaction",
        @"This sample demonstrates the use of `Interaction<TInput, TOutput>` to confirm deletion of dinosaurs with the user, with an Rx-based handler.
